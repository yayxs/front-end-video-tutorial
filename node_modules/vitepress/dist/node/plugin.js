...
function createVitePressPlugin(root, { configPath, alias, markdown, site, vueOptions, pages }, ssr = false, pageToHashMap) {
    const markdownToVue = markdownToVue_1.createMarkdownToVueRenderFn(root, markdown, pages);
        ...
        async handleHotUpdate(ctx) {
            ...
            if (file.endsWith('.md')) {
                ...
                server.ws.send({
                    ...
                    data: {
                        path: `/${slash_1.slash(path_1.default.relative(root, file))}`,
                        pageData
                    }
                });
