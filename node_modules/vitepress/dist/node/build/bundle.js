...
async function bundle(config, options) {
    ...
    const input = {
        app: path_1.default.resolve(alias_1.APP_PATH, 'index.js')
    };
    config.pages.forEach((file) => {
        // page filename conversion
        // foo/bar.md -> foo_bar.md
        input[slash_1.slash(file).replace(/\//g, '_')] = path_1.default.resolve(root, file);
    });
    ...
    const resolveViteConfig = (ssr) => ({
        ...
        logLevel: 'warn',
        plugins: plugin_1.createVitePressPlugin(root, config, ssr, pageToHashMap),
        // @ts-ignore
        ssr: {
