...
result, appChunk, cssChunk, pageToHashMap, hashMapString) {
    ...
    const stylesheetLink = cssChunk
        ...
        : '';
    const title = pageData.title && pageData.title !== 'Home'
...
function resolvePageImports(config, page, result, indexChunk) {
    ...
    const srcPath = vite_1.normalizePath(fs_extra_1.default.realpathSync(path_1.default.resolve(config.root, page)));
...
function isMetaDescription(headConfig) {
    ...
    return type === 'meta' && (attrs === null || attrs === void 0 ? void 0 : attrs.name) === 'description';
}
